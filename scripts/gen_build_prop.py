...
def parse_args():
  ...
  config["CorporaDesc"] = config["BuildDesc"]
  config["CorporaDevice"] = config["DeviceName"]
...
def generate_build_info(args):
  ...
  if config["BuildVariant"] == "user":
    ...
    print(f"ro.build.display.id?={config['CorporaDesc']}")
  ...
  print(f"ro.corpora.device={config['CorporaDevice']}")
